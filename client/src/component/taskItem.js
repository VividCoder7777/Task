    ...
    render(){
        ...
        return (
            <div className={taskComplete == false ? 'taskEntry' : 'taskEntryCompleted'}>
                ...
                <p id='taskTitle' className='content'><span className='subTitle'>Task Title -</span> {title}</p>
                <p id='taskDetail' className='content'><span className='subTitle'>Description -</span> {description}</p>
                <div id='children'>
